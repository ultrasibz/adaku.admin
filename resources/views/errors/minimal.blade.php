...
<div class="d-flex flex-column flex-root" id="kt_app_root">
    <!--begin::Page bg image-->
    <style>body { background-image: url('{{asset('')}}/media/bg.jpg'); } [data-theme="dark"] body { background-image: url('assets/media/auth/bg7-dark.jpg'); }</style>
    <!--end::Page bg image-->
        ...
        <div class="d-flex flex-column flex-center text-center p-10">
            ...
            <div class="card card-flush w-lg-650px py-5">
                <div class="card-body py-15 py-lg-20">
                    <!--begin::Title-->
                    <h1 class="fw-bolder fs-2qx text-gray-900 mb-4">@yield('code')</h1>
                    <!--end::Title-->
                    <!--begin::Text-->
                    ...
                    <!--begin::Illustration-->
{{--                    <div class="mb-11">--}}
{{--                        <img src="{{asset('')}}/media/auth/500-error.png" class="mw-100 mh-300px theme-light-show" alt="" />--}}
{{--                        <img src="{{asset('')}}/media/auth/500-error-dark.png" class="mw-100 mh-300px theme-dark-show" alt="" />--}}
{{--                    </div>--}}
                    <!--end::Illustration-->
                    <!--begin::Link-->
                    <div class="mb-0">
